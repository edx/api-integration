...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('edx_solutions_api_integration_coursemodulecompletion', 'stage',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('edx_solutions_api_integration_coursemodulecompletion', 'stage')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'projects'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['edx_solutions_api_integration.Organization']"})  # pylint: disable=C0301
        },
        'projects.workgroup': {
