...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('edx_solutions_api_integration_coursecontentgrouprelationship', 'group_id')

        # Adding field 'CourseContentGroupRelationship.group_profile'
        db.add_column('edx_solutions_api_integration_coursecontentgrouprelationship', 'group_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['edx_solutions_api_integration.GroupProfile']),  # pylint: disable=C0301
                      keep_default=False)

        # Adding unique constraint on 'CourseContentGroupRelationship', fields ['course_id', 'content_id', 'group_profile']
        db.create_unique('edx_solutions_api_integration_coursecontentgrouprelationship', ['course_id', 'content_id', 'group_profile_id'])  # pylint: disable=C0301

    def backwards(self, orm):
        # Removing unique constraint on 'CourseContentGroupRelationship', fields ['course_id', 'content_id', 'group_profile']
        db.delete_unique('edx_solutions_api_integration_coursecontentgrouprelationship', ['course_id', 'content_id', 'group_profile_id'])  # pylint: disable=C0301

        # Adding field 'CourseContentGroupRelationship.group'
        db.add_column('edx_solutions_api_integration_coursecontentgrouprelationship', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['edx_solutions_api_integration.GroupProfile']),  # pylint: disable=C0301
                      keep_default=False)

        # Deleting field 'CourseContentGroupRelationship.group_profile'
        db.delete_column('edx_solutions_api_integration_coursecontentgrouprelationship', 'group_profile_id')
