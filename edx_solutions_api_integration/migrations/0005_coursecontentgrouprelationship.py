...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('edx_solutions_api_integration_coursecontentgrouprelationship', (
            ...
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edx_solutions_api_integration.GroupProfile'])),  # pylint: disable=C0301
            ('record_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('edx_solutions_api_integration', ['CourseContentGroupRelationship'])
        db.create_index('edx_solutions_api_integration_coursecontentgrouprelationship', ['course_id', 'content_id'], unique=False, db_tablespace='')  # pylint: disable=C0301

    def backwards(self, orm):
        # Deleting model 'CourseContentGroupRelationship'
        db.delete_table('edx_solutions_api_integration_coursecontentgrouprelationship')
