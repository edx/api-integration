...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('edx_solutions_api_integration_coursemodulecompletion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='course_completions', to=orm['auth.User'])),  # pylint: disable=C0301
            ('course_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('content_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
        ))
        db.send_create_signal('edx_solutions_api_integration', ['CourseModuleCompletion'])

    def backwards(self, orm):
        # Deleting model 'CourseModuleCompletion'
        db.delete_table('edx_solutions_api_integration_coursemodulecompletion')
