...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('auth_groupprofile', 'group_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.Group'], unique=True))  # pylint: disable=C0301
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GroupProfile.group'
        db.alter_column('auth_groupprofile', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group']))  # pylint: disable=C0301
