...
def _get_course_progress_metrics(course_key, **kwargs):
    ...
    progress_sum, total_possible_completions = get_total_completions(course_key, percent_completion=True, **kwargs)
    ...
    if total_users and progress_sum:
        course_avg = float(progress_sum) / total_users
    data['course_avg'] = course_avg
