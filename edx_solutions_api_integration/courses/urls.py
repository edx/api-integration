...
urlpatterns = patterns(
    ...
    url(r'^{0}/average_scores/(?P<score_type>\w+)/*$'.format(COURSE_ID_PATTERN),
    ...
    url(r'^{0}/metrics/leaders/*$'.format(COURSE_ID_PATTERN),
    ...
    url(r'submission_map$', courses_views.CoursesSubmissionMap.as_view()),
